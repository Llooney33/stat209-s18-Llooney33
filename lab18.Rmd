...
Does the mean agree with your answer to question 2? Yes
...
What is the range of mean salaries implied by the confidence interval? $55,138 to $58,737
...
or why not? No there are salaries upwards of the mean and some that are lower. The mean is skewed due to the outliers. 
...
degree. Does this range intersect the one you had in question 5? It is larger than the range in question 5 but it does intersect it.
...
**Answer**: 33.07 to 34.65

Describe in words how the proceeding confidence interval should be
interpreted.

**Answer**: There is an 80% chance that the mean will fall between 33.07 and 34.65
