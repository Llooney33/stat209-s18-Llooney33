...
Answer: 154 observations, one row for every unqiue combination of area_number and night flag. The burglary rate increases as the median income level drops. However, during the day there is not a large correlation between burglary rate and median income. 
...
ggplot(crimes_time_ca, aes(median_income, burglary_rate)) +
  ...
  geom_smooth(aes(color = factor(night_flag)), method = "lm") +
  scale_color_viridis(discrete = TRUE) +
  annotate("point", x = 26693, y = 20.0485044, color = "red", size = 3) +
  annotate("point", x = 26693, y = 3.6378335, color = "red", size = 3) +
  annotate("text",label = "West Englewood", x = 26693, y = 4.5, size = 3) +
  annotate("text", label = "West Englewood", x = 26693, y = 21, size = 3) +
annotate("point", x = 18412, y = 0, color = "blue", size = 3) +
  annotate("point", x = 18412, y = 10.9631950, color = "blue", size = 3) +
  annotate("text",label = "Fuller Park", x = 18412, y = 1, size = 3) +
  annotate("text", label = "Fuller Park", x = 18412, y =11.5, size = 3) +
  annotate("point", x = 68296, y = 1.149505, color = "green", size = 3) +
  annotate("point", x = 68296, y = 6.6101451, color = "green", size = 3) +
  annotate("text",label = "Forest Glen", x = 68296, y = 2, size = 3) +
  annotate("text", label = "Forest Glen", x = 68296, y = 7.2, size = 3)
```

Thesis Statement:
Burglary rates increase significantly at night and that is only exagerated by areas with lower income rates. As income levels increase, night time burglary rates do no significantly differ from the day time rates
