...
**Answer**: The slope coefficient is 7756 which is how much the price will rise every time a carat is added to a diamond. 
...
**Answer**: A diamond with 0 carats is the value of the intercept, but none of the data has 0 carats. Therefore the slope is added to the intercept to get how much the price would rise when one carat is added (or the diamond has 1 carat, you can't "add" a carat)
...
**Answer**: 5,763 - 60(29) = 4,023

Describe in words the estimate of the slope in terms of the dataset.

**Answer**: The smaller the depth of a diamond, the higher the price is.
...
**Answer**: Only neagtive values

Interpret this in words (your words, not just the formal definition).

**Answer**: Price and depth have a negative correlation
...
**Answer**: 4045.3 - 50(102.2) + (7765.1(2)) = $14,465.50

Are both of the slopes in the model statistically significant? What are
their signs?

**Answer**: both are statistically significant, 0 is not present in either confidence interval
...
**Answer**: The slope of carats is that you multiply the carats by 7765, which will then allow you to add that price to the intercept, along with the depth slope which is -102 multiplied by the depth of the diamond, to get the total price for the diamond. They are fixed values which can be multiplied to obtain a prediction of price. 
...
**Answer**: 7765 more than the 1 carat diamond. 
